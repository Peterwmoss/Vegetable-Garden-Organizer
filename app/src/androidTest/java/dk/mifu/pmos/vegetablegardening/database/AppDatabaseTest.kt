...
class AppDatabaseTest {
    ...
    inner class CreateBedTest {
        private fun createBedNameParameters(): Iterable<Pair<Bed, String>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Outdoors, HashMap(), columns = 0, rows = 0, 0), "Test1"),
                    Pair(Bed("Test2", 2021, Outdoors, HashMap(), columns = 0, rows = 0, 1), "Test2"),
            )
        }
        ...
        private fun createBedLocationParameters(): Iterable<Pair<Bed, BedLocation>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Outdoors, HashMap(), columns = 0, rows = 0, 0), Outdoors),
                    Pair(Bed("Test2", 2021, Greenhouse, HashMap(), columns = 0, rows = 0, 1), Greenhouse),
            )
        }
        ...
        private fun createBedPlantsParameters(): Iterable<Pair<Bed, Map<Coordinate, MyPlant>>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Greenhouse, columns = 0, rows = 0, order = 0), HashMap()),
                    Pair(Bed("Test2", 2021, Greenhouse, mapOf(pair1), columns = 0, rows = 0, order = 1), mapOf(pair1)),
                    Pair(Bed("Test3", 2021, Greenhouse, mapOf(pair1, pair2), columns = 0, rows = 0, order = 2), mapOf(pair1, pair2)),
            )
        }
        ...
        private fun createBedSizeParameters(): Iterable<Pair<Bed, Pair<Int, Int>>>{
            return listOf(
                    Pair(Bed("Test1", 2021, Greenhouse, columns = 0, rows = 0, order = 0), Pair(0,0)),
                    Pair(Bed("Test2", 2021, Greenhouse, columns = 1, rows = 0, order = 0), Pair(1,0)),
                    Pair(Bed("Test3", 2021, Greenhouse, columns = 0, rows = 1, order = 0), Pair(0,1)),
                    Pair(Bed("Test4", 2021, Greenhouse, columns = 1, rows = 1, order = 0), Pair(1,1)),
                    Pair(Bed("Test5", 2021, Greenhouse, columns = 2, rows = 1, order = 0), Pair(2,1))
            )
        }
    ...
    inner class UpdateBedTest {
        private fun updateBedWithLocationParameters(): Iterable<Pair<Bed, BedLocation>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Greenhouse, columns = 0, rows = 0, order = 0), Greenhouse),
                    Pair(Bed("Test2", 2021, Outdoors, columns = 0, rows = 0, order = 0), Outdoors),
                    Pair(Bed("Test3", 2021, Greenhouse, columns = 0, rows = 0, order = 0), Outdoors),
                    Pair(Bed("Test4", 2021, Outdoors, columns = 0, rows = 0, order = 0), Greenhouse),
            )
        }
        ...
        private fun updateBedWithPlantsParameters(): Iterable<Pair<Bed, Map<Coordinate, MyPlant>>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Greenhouse, columns = 0, rows = 0, order = 0), mapOf(pair1)),
                    Pair(Bed("Test2", 2021, Greenhouse, mapOf(pair2), columns = 0, rows = 0, order = 0), mapOf(pair1, pair2)),
            )
        }
        ...
        private fun updateBedWithSizeParameters(): Iterable<Pair<Bed, Pair<Int, Int>>> {
            return listOf(
                    Pair(Bed("Test1", 2021, Greenhouse, columns = 0, rows = 0, order = 0), Pair(1,1)),
                    Pair(Bed("Test2", 2021, Greenhouse, columns = 2, rows = 1, order = 0), Pair(1,0))
            )
        }
        ...
        fun updateBedWithSizeTest() = updateBedWithSizeParameters().map { (bed, newSize) ->
            DynamicTest.dynamicTest("Update bed with new size updates the bed to have the new size") {
                bedDao.insert(bed)
                val newBed = Bed(bed.name, 2021, Greenhouse, columns = newSize.first, rows = newSize.second, order = 0)
    ...
    inner class DeleteBedTest {
        ...
        fun deleteBedTest() {
            val name = "Test1"
            val bed = Bed(name, 2021, Outdoors, columns = 0, rows = 0, order = 0)
            bedDao.insert(bed)
        ...
        fun deleteBedDoesNotDeleteWrongTest() {
            // Bed 1
            val name1 = "Test1"
            val bed1 = Bed(name1, 2021, Outdoors, columns = 0, rows = 0, order = 0)
            bedDao.insert(bed1)
            // Bed 2
            val name2 = "Test2"
            val bed2 = Bed(name2, 2021, Outdoors, columns = 0, rows = 0, order = 0)
            bedDao.insert(bed2)
        ...
        fun deleteBedNoExistDoesNothingTest() {
            ...
            val nameToKeep = "Keep"
            val bed = Bed(nameToKeep, 2021, Outdoors, columns = 0, rows = 0, order = 0)
            bedDao.insert(bed)
