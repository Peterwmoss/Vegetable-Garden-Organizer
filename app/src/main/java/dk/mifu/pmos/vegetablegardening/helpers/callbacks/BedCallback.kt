...
class BedCallback(private val view: View, private val bedViewModel: BedViewModel): ObservableMap.OnMapChangedCallback<ObservableMap<Coordinate, Plant>, Coordinate, Plant>() {
